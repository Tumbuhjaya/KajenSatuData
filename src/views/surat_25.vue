    ...
    <ion-header style="box-shadow: none;">
      <div class="box-header">
        <div class="box-title">
          ...
          <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Permohomam Duplikasi Surat Nikah</h6>
      </div>
      </div>
    </ion-header>
    <ion-content :fullscreen="true" id="page-dashboard">
      ...
      <ion-grid style="padding: 60px 20px !important;">
        <ion-row>
          ...
          <ion-col size="12">
            <ion-input label="Tanggal Nikah" v-model="tanggal" labelPlacement="stacked" placeholder="" type="date"></ion-input>
          </ion-col>
