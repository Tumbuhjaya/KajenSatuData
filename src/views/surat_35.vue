      ...
      <ion-header style="box-shadow: none;">
        <div class="box-header">
          <div class="box-title">
            ...
            <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Keterangan Penghasilan Orangtua</h6>
        </div>
        </div>
      </ion-header>
      <ion-content :fullscreen="true" id="page-dashboard">
        ...
        <ion-grid style="padding: 60px 20px !important;">
          <ion-row>
              ...
              <ion-col size="12">
                  <ion-input label="Nomor Induk Siswa / Mahasiswa" v-model="nis" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>

              <ion-col size="12">
                  <ion-input label="Sekolah / Perguruan Tinggi" v-model="sekolah" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>

              <ion-col size="12">
                  <ion-input label="Kelas / Semester" v-model="kelas" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>

              <ion-col size="12">
                  <ion-input label="Jurusan / Fakultas / Prodi" v-model="jurusan" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>
              ...
              <ion-col size="12">
                  <ion-input label="Penghasilan Ayah" v-model="penghasilan_ayah" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>
              <ion-col size="12">
              ...
              <ion-col size="12">
                  <ion-input label="Penghasilyan Ibu" v-model="penghasilan_ibu" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>
