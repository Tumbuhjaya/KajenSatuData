<template>
      ...
      <ion-header style="box-shadow: none;">
        <div class="box-header">
          <div class="box-title">
            ...
            <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Keterangan Izin Keramaian</h6>
        </div>
        </div>
      </ion-header>
      ...
      <ion-img src="/assets/shape-new-two.png" style="position: fixed;bottom:0;left:0;right:0;"></ion-img>
        <ion-grid style="padding: 60px 20px !important;">
          <ion-row >
            ...
            <ion-col size="12">
              <ion-input label="Jenis Acara" v-model="acara" labelPlacement="stacked" placeholder=""></ion-input>
            </ion-col>
            <ion-col size="12">
  ...
  export default defineComponent({
    ...
    let formData = new FormData()
		...
		formData.append('surat', 11)
		formData.append('nik', this.nik)
		formData.append('isi', {'keperluan': this.keperluan,'acara': this.acara})
