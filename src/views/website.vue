  ...
  <ion-page>
    <ion-header style="box-shadow: none;">
      <div class="box-header">
        <div class="box-title">
          <ion-icon :icon="arrowBackCircleOutline" size="large" style="position: absolute;left:0;top:0;bottom: 0;margin:auto;color: #fff;" @click="$router.push('/web_app')"></ion-icon>
          <!-- <ion-icon :icon="arrow-back-outline"></ion-icon> -->
          <h6 style="font-size: 20px;font-weight: bold;color: #fff;">Website</h6>
        </div>
      </div>
    </ion-header>
...
export default defineComponent({
  ...
  setup() {
      return { arrowBackCircleOutline, chevronForwardOutline, linkOutline };
    },
  data() {
    return {
      website:[],
