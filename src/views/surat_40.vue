      ...
      <ion-header style="box-shadow: none;">
        <div class="box-header">
          <div class="box-title">
            ...
            <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Kuasa</h6>
        </div>
        </div>
      </ion-header>
      <ion-content :fullscreen="true" id="page-dashboard">
        ...
        <ion-grid style="padding: 60px 20px !important;">
          <ion-row>
              ...
              <ion-col size="12">
                  <ion-input label="Untuk / Keperluan" v-model="keperluan" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>
