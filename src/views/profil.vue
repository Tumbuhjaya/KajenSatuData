            ...
            <div style="width: 100%;background-color: #fff;display: flex;">
              <div style="width: 40%;position: relative;background-color: ;display: flex;justify-content: center;">
                <div style="width: 140px;height: 140px;border-radius: 100%;overflow: hidden;">
                  <ion-img src="/assets/user-ksd-2.png" style="width:100%;height:140px;object-fit: cover;"></ion-img>
                </div>
              ...
              <div style="width:60%;margin-left: 15px;height: 140px;display: flex;justify-content: center;align-items: flex-start;flex-direction: column;">
                ...
                <h6 style="font-size: 14px;margin-top: 10px !important;font-weight: normal;">Nama desa yang dipilih</h6>
                <h6 style="font-size: 14px;margin-top: 5px !important;font-weight: normal;">081212334343</h6>
                <h6 style="font-size: 14px;margin-top: 5px !important;font-weight: normal;">example@gmail.com</h6>
            ...
            <ion-col size="12">
                ...
                <ion-item>
                    <div style="display: flex;justify-content: center;align-items: center;">
                        ...
                        <ion-label style="margin-left:15px ;">Logout</ion-label>
                    </div>
                </ion-item>
                </ion-list>
            </ion-col>
