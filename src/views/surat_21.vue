      ...
      <ion-header style="box-shadow: none;">
        <div class="box-header">
          <div class="box-title">
            ...
            <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Keterangan Lahir Mati</h6>
        </div>
        </div>
      </ion-header>
      <ion-content :fullscreen="true" id="page-dashboard">
        ...
        <ion-grid style="padding: 60px 20px !important;">
          <ion-row>
            ...
            <ion-col size="12">
              <ion-input label="Tanggal Mati" v-model="tanggal" labelPlacement="stacked" placeholder="" type="date"></ion-input>
            </ion-col>
            <ion-col size="12">
              <ion-input label="Tempat Mati" v-model="tempat" labelPlacement="stacked" placeholder=""></ion-input>
            </ion-col>
            <ion-col size="12">
              <ion-input label="Lama di Kandungan" v-model="lama" labelPlacement="stacked" placeholder=""></ion-input>
            </ion-col>
            <ion-col size="12">
              <ion-input label="Nama Pelapor" v-model="pelapor" labelPlacement="stacked" placeholder="" ></ion-input>
            </ion-col>
            <ion-col size="12">
              <ion-input label="Hubungan dengan yang Lahir Mati" v-model="hubungan" labelPlacement="stacked" placeholder=""></ion-input>
            </ion-col>
