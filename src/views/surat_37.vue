      ...
      <ion-header style="box-shadow: none;">
        <div class="box-header">
          <div class="box-title">
            ...
            <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Keterangan Penghasilan Ayah</h6>
        </div>
        </div>
      </ion-header>
      <ion-content :fullscreen="true" id="page-dashboard">
        ...
        <ion-grid style="padding: 60px 20px !important;">
          <ion-row>
              ...
              <ion-col size="12">
                  <ion-input label="Nama Ayah" v-model="nama" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>

              <ion-col size="12">
                  <ion-input label="NIK Ayah" v-model="nik2" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>

              <ion-col size="12">
                  <ion-input label="Alamat Ayah" v-model="alamat" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>

              <ion-col size="12">
                  <ion-input label="Penghasilan Ayah" v-model="penghasilan" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>
              ...
              <ion-col size="12">
                  <ion-input label="Sekolah" v-model="sekolah" labelPlacement="stacked" placeholder=""></ion-input>
              </ion-col>
