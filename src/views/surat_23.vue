    ...
    <ion-header style="box-shadow: none;">
      <div class="box-header">
        <div class="box-title">
          ...
          <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Keterangan Pergi Kawin</h6>
      </div>
      </div>
    </ion-header>
    <ion-content :fullscreen="true" id="page-dashboard">
      ...
      <ion-grid style="padding: 60px 20px !important;">
        <ion-row>
          ...
          <ion-col size="12">
            <ion-input label="Tujuan" v-model="tujuan" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>
          <ion-col size="12">
...
export default defineComponent({
  ...
  formData.append('surat', 23)
  formData.append('nik', this.nik)
  formData.append('isi', {'keperluan': this.keperluan,'tujuan': this.tujuan})
