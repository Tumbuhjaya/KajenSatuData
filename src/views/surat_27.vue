    ...
    <ion-header style="box-shadow: none;">
      <div class="box-header">
        <div class="box-title">
          ...
          <h6 style="font-size: 20px;font-weight: bold;color: #1c47bc;text-align: center;">Keterangan Pengantar Rujuk/Cerai</h6>
      </div>
      </div>
    </ion-header>
    <ion-content :fullscreen="true" id="page-dashboard">
      ...
      <ion-grid style="padding: 60px 20px !important;">
        <ion-row>
          ...
          <ion-col size="12">
            <ion-input label="Nama Pasangan" v-model="nama" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>

          <ion-col size="12">
            <ion-input label="Tempat Lahir Pasangan" v-model="tempat_lahir" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>

          <ion-col size="12">
            <ion-input label="Tanggal Lahir Pasangan" v-model="tgl_lahir" labelPlacement="stacked" placeholder=""  type="date"></ion-input>
          </ion-col>

          <ion-col size="12">
            <ion-input label="Warga Negara Pasangan" v-model="negara" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>

          <ion-col size="12">
            <ion-input label="Nama Ayah Pasangan" v-model="ayah" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>

          <ion-col size="12">
            <ion-input label="Agama Pasangan" v-model="agama" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>

          <ion-col size="12">
            <ion-input label="Pekerjaan Pasangan" v-model="pekerjaan" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>

          <ion-col size="12">
            <ion-input label="Tempat Tinggal Pasangan" v-model="alamat" labelPlacement="stacked" placeholder=""></ion-input>
          </ion-col>
